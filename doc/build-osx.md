Mac OS X pandacoind build instructions
====================================
...
A pandacoind binary is not included in the Pandacoin-Qt.app bundle. You can ignore
this section if you are building `pandacoind` for your own use.
...
on an OS X 10.6 64-bit machine fails. Official release builds of Pandacoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Pandacoin-Qt.app` is easy:
