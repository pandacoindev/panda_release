...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 34103 or testnet: 19333)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 34102 or testnet: 19332)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Pandacoin Wiki for SSL setup instructions)") + "\n" +
