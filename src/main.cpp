...
uint256 hashGenesisBlock("0xa3698e7e40f5d8d5ac4675890c0613bb35cde8f1751bac5161496a47808a0805");
...
{
    int64 nSubsidy = 91.146 * COIN;

    // Subsidy is reduced every 24h
    int exponent=(nHeight / 576);
    for(int i=0;i<exponent;i++){
        nSubsidy=nSubsidy*9975;
        nSubsidy=nSubsidy/10000;
    }

    if (nHeight > 14 && nHeight < 25) {nSubsidy = 42000 * COIN;} // Premine 2% for support, marketing & buyouts

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60 * 2; // Pandacoin: adjust difficulty based on the past 2 hours
static const int64 nTargetSpacing = 2.5 * 60; // Pandacoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Pandacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Pandacoin 2014!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388859178;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2756503;
        ...
        assert(block.hashMerkleRoot == uint256("0xb0f944d9e468fcb6eefe8d8da0e4fbbe1f787b9bef2a0263e8dd8d7ba51773fc"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Pandacoin: increase each by adding 2 to bitcoin's value.
